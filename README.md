...
A arquitetura foi desenhada para alta disponibilidade e performance em ambientes _serveless_ (Edge), garantindo inicilizações instantâneas (_zero cold-start_).
...
3. **Auditoria e Ajustes:** Despesas de meses já fechados recebem bloqueio lógico para edição. Correções necessárias geram "gastos de ajustes" automáticos no cilco subsequente.
...
O banco de dados relacinal foi modelado para suportar offline-first no mobile, utilizando UUIDs gerados no cliente e salvos como "TEXT".
